...
class EquipmentWarehouse:
    ...
    def recieve_equipment(self):
        ...
        self.orders.append(
            {"eqipment": eq.model, "quantity": quantity, "department": "warehouse", "id": len(self.orders) + 1})
    ...
    def ship_equipment(self):
        ...
        self.orders.append(
            {"eqipment": eq.model, "quantity": -quantity, "department": department, "id": len(self.orders) + 1})
